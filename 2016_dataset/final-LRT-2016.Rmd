...
dat <- read_sav(file = "snapshot2016you.sav")
N <- nrow(dat)
```
...
for ( i in 1:length(covars) ) {
  ...
  outNam1 <- paste0("output-", covars[i], "-2016.csv")
  outNam2 <- paste0("output-step2-", covars[i], "-2016.csv")
...
write.csv(x = bestModels,
          file = ifelse( test = resTes == "",
                         yes = paste0("final-LRT-2016.csv"),
                         no =  paste0("final-LRT-", resTes, "-2016.csv") ),
          row.names = FALSE)
rm(list = ls())
```
