...
subtitle: "2016 dataset, all models"
...
#### Creating all possible models for a single covar
...
Set default values.
```{r}
dat <- read_sav(file = "snapshot2016you.sav") # load dataset
...
for ( i in 1:nrow(z) ) {
  ...
  assign(x = "datPat", value = "snapshot2016you.sav")
  ...
  ########################
  if (i == 1) {
    synNam1 <- paste0("syntax-model-", covar, "-2016.lgs")
