...
subtitle: "2016 dataset, step2 models"
...
Data used: `snapshot2016you.sav` and `data2016Step0.sav`
...
for ( i in 1:length(z) ) {
  ...
  outToDo <- paste0( ifelse(test = i == 1, yes = "write=", no = "append="),
                     paste0("'output-step2-" , covar, "-2016.csv'") )
  ...
  assign(x = "datPat", value = "data2016Step0.sav")
  ...
  ########################
  if (i == 1) {
    synNam1 <- paste0("syntax-step2-", covar, "-2016.lgs")
