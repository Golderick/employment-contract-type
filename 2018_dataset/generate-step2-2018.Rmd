...
subtitle: "2018 dataset, step2 models"
...
Data used: `snapshot2018you.sav` and `data2018Step0.sav`
...
for ( i in 1:length(z) ) {
  ...
  outToDo <- paste0( ifelse(test = i == 1, yes = "write=", no = "append="),
                     paste0("'output-step2-" , covar, "-2018.csv'") )
  ...
  assign(x = "datPat", value = "data2018Step0.sav")
  ...
  ########################
  if (i == 1) {
    synNam1 <- paste0("syntax-step2-", covar, "-2018.lgs")
