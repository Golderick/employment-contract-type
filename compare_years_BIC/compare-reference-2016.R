...
## This script uses the results from the folders '2016_dataset', "2017_dataset", and "2018_dataset".
...
# sample size
dat <- read_sav( file = paste0(path2016, "/snapshot2016you.sav") )
N <- nrow(dat)
...
# disagreement for: "software_cluster" 
covar <- final2016$covariate[!final2016$description == final2017$description]

# "software_cluster"
outputName <- paste0("output-", covar, "-2016.csv")
LGoutput <- extract.output( outPath = paste0(path2016, "/", outputName), Nob = N)
# 2017 w.r.t. 2016
LGoutput[LGoutput$nam == final2017[final2017$covariate == covar, "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2016[final2016$covariate == covar, "description"], "BIC.LL"]
# difference = 3.629778; "positive" evidence (Raftery, 1995, p.139)
...
# disagreement for: "economic_activity", "software_cluster" and "work_hours"
covar <- final2016R$covariate[!final2016R$description == final2017R$description]

# "economic_activity"
outputName <- paste0("output-", covar[1], "-2016.csv")
LGoutput <- extract.output( outPath = paste0(path2016, "/", outputName), Nob = N)
# 2017 w.r.t. 2016
...
# difference = 3.176121; "positive" evidence (Raftery, 1995, p.139)

# "software_cluster"
outputName <- paste0("output-", covar[2], "-2016.csv")
LGoutput <- extract.output( outPath = paste0(path2016, "/", outputName), Nob = N)
# 2017 w.r.t. 2016
...
# difference = 24.30207; "very strong" evidence (Raftery, 1995, p.139)

# "work_hours"
outputName <- paste0("output-", covar[3], "-2016.csv")
LGoutput <- extract.output( outPath = paste0(path2016, "/", outputName), Nob = N)
# 2017 w.r.t. 2016
LGoutput[LGoutput$nam == final2017R[final2017R$covariate == covar[3], "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2016R[final2016R$covariate == covar[3], "description"], "BIC.LL"]
# difference = 7.799795; "strong" evidence (Raftery, 1995, p.139)
...
covar <- final2016$covariate[!final2016$description == final2018$description]
...
# difference = 33.57889; "very strong" evidence (Raftery, 1995, p.139)
...
covar <- final2016R$covariate[!final2016R$description == final2018R$description]
...
LGoutput[LGoutput$nam == final2018R[final2018R$covariate == covar[1], "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2016R[final2016R$covariate == covar[1], "description"], "BIC.LL"]
# difference = 10.26301; "very strong" evidence (Raftery, 1995, p.139)
...
LGoutput[LGoutput$nam == final2018R[final2018R$covariate == covar[2], "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2016R[final2016R$covariate == covar[2], "description"], "BIC.LL"]
# difference = 3.201624; "positive" evidence (Raftery, 1995, p.139)
...
LGoutput[LGoutput$nam == final2018R[final2018R$covariate == covar[3], "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2016R[final2016R$covariate == covar[3], "description"], "BIC.LL"]
# difference = 35.35342; "very strong" evidence (Raftery, 1995, p.139)

# "work_hours"
outputName <- paste0("output-", covar[4], "-2016.csv")
LGoutput <- extract.output( outPath = paste0(path2016, "/", outputName), Nob = N)
# 2018 w.r.t 2016
LGoutput[LGoutput$nam == final2018R[final2018R$covariate == covar[4], "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2016R[final2016R$covariate == covar[4], "description"], "BIC.LL"]
# difference = 7.825298; "strong" evidence (Raftery, 1995, p.139)
