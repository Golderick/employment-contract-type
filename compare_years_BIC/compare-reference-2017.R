...
# sample size
dat <- read_sav( file = paste0(path2017, "/snapshot2017you.sav") )
N <- nrow(dat)
...
covar <- final2017$covariate[!final2017$description == final2016$description]

# "software_cluster"
outputName <- paste0("output-", covar, "-2017.csv")
LGoutput <- extract.output( outPath = paste0(path2017, "/", outputName), Nob = N)
# 2016 w.r.t. 2017
...
# difference = 20.59121; "very strong" evidence (Raftery, 1995, p.139)
...
covar <- final2017R$covariate[!final2017R$description == final2016R$description]

# "economic_activity"
outputName <- paste0("output-", covar[1], "-2017.csv")
LGoutput <- extract.output( outPath = paste0(path2017, "/", outputName), Nob = N)
# 2016 w.r.t. 2017
...
# difference = 59.52666; "very strong" evidence (Raftery, 1995, p.139)

# "software_cluster"
outputName <- paste0("output-", covar[2], "-2017.csv")
LGoutput <- extract.output( outPath = paste0(path2017, "/", outputName), Nob = N)
# 2016 w.r.t 2017
...
# difference = 1.101388; "weak" evidence (Raftery, 1995, p.139)

# "work_hours"
outputName <- paste0("output-", covar[3], "-2017.csv")
LGoutput <- extract.output( outPath = paste0(path2017, "/", outputName), Nob = N)
# 2016 w.r.t 2017
...
# difference = 14.40516; "very strong" evidence (Raftery, 1995, p.139)
...
covar <- final2017$covariate[!final2017$description == final2018$description]
...
# difference = 25.01016; "very strong" evidence (Raftery, 1995, p.139)
...
covar <- final2017R$covariate[!final2017R$description == final2018R$description]
...
LGoutput[LGoutput$nam == final2018R[final2018R$covariate == covar[1], "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2017R[final2017R$covariate == covar[1], "description"], "BIC.LL"]
# difference = 2.723545; "positive" evidence (Raftery, 1995, p.139)
...
LGoutput[LGoutput$nam == final2018R[final2018R$covariate == covar[2], "description"], "BIC.LL"] -
  LGoutput[LGoutput$nam == final2017R[final2017R$covariate == covar[2], "description"], "BIC.LL"]
# difference = 13.15578; "very strong" evidence (Raftery, 1995, p.139)
